              ...
              >
                <div className="ownersapproval-row-left">
                  <div className="ownersapproval-avatar">
                    {(owner.owner_profile?.name || 'O')[0].toUpperCase()}
                  </div>
                  <div className="ownersapproval-info">
                    <div className="flex items-center gap-2">
                      <h3>{owner.owner_profile?.name || 'Canteen Owner'}</h3>
                    ...
                    <p className="text-sm text-muted">📞 {owner.owner_profile?.phone}</p>
                    {owner.owner_profile?.fssai_license && (
                      <p className="text-sm text-muted">📜 FSSAI: {owner.owner_profile.fssai_license}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="ownersapproval-actions">
                  {!owner.is_approved ? (
                    <button
                      ...
                      onClick={() => approve(owner.id, owner.owner_profile?.name)}
                    ...
                    <button
                      ...
                      onClick={() => reject(owner.id, owner.owner_profile?.name)}
                      disabled={acting[owner.id]}
                    >
