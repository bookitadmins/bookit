...
- **Endpoint Exports:** Groups API calls into `authAPI`, `canteensAPI`, `menuAPI`, and `ordersAPI` for easy consumption.
...
- **Helpers:** Provides boolean flags like `isOwner`, `isStudent`, and `isAuthenticated`.
